      ...
      <div className="flex items-center gap-4 transform transition-all duration-300">
        <div className="flex items-stretch rounded-md border border-border overflow-hidden h-[48px] transform transition-all duration-300">
          <Button 
            variant="ghost" 
            size="icon" 
            className="h-[48px] w-[48px] rounded-none border-r border-border transform transition-all duration-300"
          ...
          <div className="flex flex-col items-center transform transition-all duration-300">
            <div className={cn(
              ...
              <span className="text-lg transform transition-all duration-300">{quantity}</span>
            </div>
            <div className={cn(
              ...
              quantity < threshold 
                ...
                : "bg-[#D4D4D4] text-black border border-[#D4D4D4]"
            )}>
              <span className="text-xs transform transition-all duration-300 mb-2.5">{threshold} PCS</span>
            </div>
          </div>
          <Button 
            variant="ghost" 
            size="icon" 
            className="h-[48px] w-[48px] rounded-none border-l border-border transform transition-all duration-300"
